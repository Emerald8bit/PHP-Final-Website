...
<head>
    <meta charset="utf-8">
    <title>Photo Tamer Contact</title>
        ...
        <div class="row g-5 mb-5">
            <div class="col-lg-4">
                <div class="d-flex flex-column align-items-center bg-dark rounded text-center py-5 px-3">
                    ...
                    <p class="text-secondary mb-0">Indianapolis, IN 46203</p>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="d-flex flex-column align-items-center bg-dark rounded text-center py-5 px-3">
                    ...
                    <p class="text-secondary mb-0">Photo-tamer@gmail.com</p>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="d-flex flex-column align-items-center bg-dark rounded text-center py-5 px-3">
                    ...
                    <p class="text-secondary mb-0">555-555-5555</p>
                </div>
            </div>
        </div>
        <div class="row g-0">
            ...
            <div class="col-lg-6">
                <iframe class="w-100"
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3970.3019641637616!2d-0.20549778599974036!3d5.669406895890494!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xfdf9d349b44b623%3A0x8e895d567036ce79!2shaatso%2C%20west%20land!5e0!3m2!1sen!2sgh!4v1669819918238!5m2!1sen!2sgh" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"
